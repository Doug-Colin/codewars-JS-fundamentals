...
Return: 
    -the index of string 'needle' in the insttructed message

Example:
    ["hay", "junk", "hay", "hay", "moreJunk", "needle", "randomJunk"] --> "found the needle at position 5" 

Psuedo Code:
    -use .findIndexOf() and interpolate into string
*/
...
function findNeedle(haystack) {
    //find index of string "needle" via .indexOf(), and interpolate into string
    return `found the needle at position ${haystack.indexOf("needle")}`
  }
