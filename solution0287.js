...
Parameters: 
    -base and factor, integers

Return: 
    -true if factor is a factor of base, otherwise false.
...
function checkForFactor (base, factor) {
    //use ternary statement to check if second param is a factor of base, by using modulus/remainder operator 
    return base % factor == 0 ? true : false
  }
